...
parser.add_argument('--factor', type=int, default=2, help='prob sparse factor')
...
parser.add_argument('--learning_rate', type=float, default=0.0000002, help='optimizer learning rate')
